      ...
      _.each(fields, function(field, i){
        ...
        _.each(fieldAttr, function(attr, x){
          ...
          if (attr === "foreignKey") {
            ...
            text[table] += spaces + spaces + spaces + attr + ": app.Sequelize." + self.tables[table][field][attr];
          } else {
